...
Loan_Term_(Months) = st.slider('Duration of loan in months', 1, 60)
...
def predict(Spending_Rate, Credit_Card_Balance, Account_Balance, Loan_Amount, Age, Loan-to-Credit_Ratio, Loan_Term_(Months), Transaction_Amount, Loan_Type):
    ...
    features = np.array([['Spending_Rate', 'Credit_Card_Balance', 'Account_Balance', 'Loan_Amount', 'Age', 'Loan-to-Credit_Ratio', 'Loan_Term_(Months)', 'Transaction_Amount', 'Loan_Type']])
